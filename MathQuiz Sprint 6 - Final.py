...
class MathQuiz:
    def __init__(self, parent):
        ...
        self.questions = Label(self.frame2, bg = "black", fg = "white", width = 30, padx = 30, pady = 10,
        ...
        self.feedback = Label(self.frame2, text = "Click Check answer")
        ...
        for i in range(len(report_page)):
            ib = Label(self.report_frame, text = report_page[i], anchor = W, width = "7", height = "2", font = ("Times", "22", "bold"))
            self.report_labels.append(ib)
            ib.grid(row = 1, column = i+1, sticky = "EW")
    ...
    def show_frame2(self):
        try:
            ...
            #instance creates to check if input data is correct for the variables
            if self.name.get() == "":
